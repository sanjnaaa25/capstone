...
const Agent2 = ({
  ...
  useEffect(() => {
    ...
    const handleGenerateFeedback = async () => {
      console.log("🧠 Generating structured feedback with Gemini...");
      const transcriptText = messages
        .map((m) => `${m.role}: ${m.content}`)
        .join("\n");

      try {
        // 🧾 Ask Gemini to summarize & evaluate the interview
        const prompt = `
...
`;
        ...
        console.log("🧾 Gemini Feedback:", feedbackText);
